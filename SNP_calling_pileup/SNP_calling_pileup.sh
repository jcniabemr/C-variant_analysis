...
gff2bed < final_genes_appended_renamed.gff3 > fv_soreted.bed

vcftools --vcf WT_contigs_unmaskedSNPs_filtered_annotated.vcf --bed fv_soreted.bed --out filtered_snps.vcf --recode --keep-INFO-all