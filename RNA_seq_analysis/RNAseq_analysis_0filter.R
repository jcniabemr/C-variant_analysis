...
res= results(dds, alpha=alpha,contrast=c("Group","21","39"))
sig.res <- subset(res,padj<=alpha)
sig.res <- sig.res[order(sig.res$padj),]
sig.res.upregulated <- sig.res[sig.res$log2FoldChange >=1, ]
sig.res.downregulated <- sig.res[sig.res$log2FoldChange <=-1, ]
summary(sig.res)
write.table(sig.res,"DeSeq2/independent_deg/TP1/11/C11_vs_WT_TP1_RES.txt",sep="\t",na="",quote=F)
write.table(sig.res.upregulated,"DeSeq2/independent_deg/TP1/11/C11_VS_WT_TP1_UP.txt",sep="\t",na="",quote=F)
write.table(sig.res.downregulated,"DeSeq2/independent_deg/TP1/11/C11_VS_WT_TP1_DN.txt",sep="\t",na="",quote=F)

res= results(dds, alpha=alpha,contrast=c("Group","23","39"))
sig.res <- subset(res,padj<=alpha)
sig.res <- sig.res[order(sig.res$padj),]
sig.res.upregulated <- sig.res[sig.res$log2FoldChange >=1, ]
sig.res.downregulated <- sig.res[sig.res$log2FoldChange <=-1, ]
summary(sig.res)
write.table(sig.res,"DeSeq2/independent_deg/TP1/12/C12_vs_WT_TP1_RES.txt",sep="\t",na="",quote=F)
write.table(sig.res.upregulated,"DeSeq2/independent_deg/TP1/12/C12_VS_WT_TP1_UP.txt",sep="\t",na="",quote=F)
write.table(sig.res.downregulated,"DeSeq2/independent_deg/TP1/12/C12_VS_WT_TP1_DN.txt",sep="\t",na="",quote=F)

res= results(dds, alpha=alpha,contrast=c("Group","25","39"))
sig.res <- subset(res,padj<=alpha)
sig.res <- sig.res[order(sig.res$padj),]
sig.res.upregulated <- sig.res[sig.res$log2FoldChange >=1, ]
sig.res.downregulated <- sig.res[sig.res$log2FoldChange <=-1, ]
summary(sig.res)
write.table(sig.res,"DeSeq2/independent_deg/TP1/13/C13_vs_WT_TP1_RES.txt",sep="\t",na="",quote=F)
write.table(sig.res.upregulated,"DeSeq2/independent_deg/TP1/13/C13_VS_WT_TP1_UP.txt",sep="\t",na="",quote=F)
write.table(sig.res.downregulated,"DeSeq2/independent_deg/TP1/13/C13_VS_WT_TP1_DN.txt",sep="\t",na="",quote=F)

res= results(dds, alpha=alpha,contrast=c("Group","27","39"))
sig.res <- subset(res,padj<=alpha)
sig.res <- sig.res[order(sig.res$padj),]
sig.res.upregulated <- sig.res[sig.res$log2FoldChange >=1, ]
sig.res.downregulated <- sig.res[sig.res$log2FoldChange <=-1, ]
summary(sig.res)
write.table(sig.res,"DeSeq2/independent_deg/TP1/14/C14_vs_WT_TP1_RES.txt",sep="\t",na="",quote=F)
write.table(sig.res.upregulated,"DeSeq2/independent_deg/TP1/14/C14_VS_WT_TP1_UP.txt",sep="\t",na="",quote=F)
write.table(sig.res.downregulated,"DeSeq2/independent_deg/TP1/14/C14_VS_WT_TP1_DN.txt",sep="\t",na="",quote=F)
