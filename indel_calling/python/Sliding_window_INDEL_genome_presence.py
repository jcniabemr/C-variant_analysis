...
input_file_location = "/data/scratch/connellj/Fusarium_venenatum/MINion_indel_calling/alignments/"
output_file_name = "/data/scratch/connellj/Fusarium_venenatum/MINion_indel_calling/alignments/indel_calling_no_errors.csv"
...
error_SNPs = function_for_vcf_in ("/data/scratch/connellj/Fusarium_venenatum/MINion_indel_calling/alignments/WT_alignment/svaba/WT_indel_unfiltered.vcf")
