...
# Constants
Generate .VCF of Minion called snps with no errors 
...
output_file_name = "/data/scratch/connellj/Fusarium_venenatum/MINion_SNP_Calling/sliding_window_unfiltered_SNP_calling_1000bp_genome_prsence.vcf"
...
with open (output_file_name, "wb") as file_out:
 ...
 Generate .CSV of single variants called in both SNP calling and SV calling 
```python 
chromsome_multiplier = 1 * 10 ** 8 # Constant to include LG in position data
input_files = ["C1","C2","C3","C4","C5","C6"]
input_file_location = "/data/scratch/connellj/Fusarium_venenatum/MINion_indel_calling/alignments/Structural_variants/"
output_file_name = "/data/scratch/connellj/Fusarium_venenatum/MINion_indel_calling/alignments/Structural_variants/SV_calling_no_errors.csv"
...
error_SNPs = function_for_vcf_in ("/data/scratch/connellj/Fusarium_venenatum/MINion_indel_calling/alignments/Structural_variants/C1/Fven_svaba_sv.svaba.unfiltered.sv_C1.vcf")
