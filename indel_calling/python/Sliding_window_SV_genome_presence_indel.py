...
# This script tells you what genome the indels are present in. indels where generated using samtools minion snp calling 
...
input_file_location = "/data/scratch/connellj/Fusarium_venenatum/MINion_indel_calling/alignments/indipendent_alignments/Structural_variants/indel/"
output_file_name = "/data/scratch/connellj/Fusarium_venenatum/MINion_indel_calling/alignments/indipendent_alignments/Structural_variants/SV_calling_no_errors_indel.csv"
...
error_SNPs = function_for_vcf_in ("/data/scratch/connellj/Fusarium_venenatum/MINion_indel_calling/alignments/WT_alignment/svaba/Fven_svaba_sv.svaba.unfiltered.indel.vcf")

for c_varient in input_files:
	file_path = input_file_location + c_varient + "/" + "Fven_svaba_sv.svaba.unfiltered.indel_" + c_varient + ".vcf" 
