...
Outdir=/projects/fusarium_venenatum_miseq/genome_synteny/                                 #replace with your output directory 
mkdir -p $Outdir
...
#Create the dot plot 
paf_file=/projects/fusarium_venenatum_miseq/genome_synteny/minimap.paf;                   #replace with paf file location 
Outdir=/projects/fusarium_venenatum_miseq/genome_synteny/                                 #replace with your output directory 
Progdir=/home/connellj/git_repos/emr_repos/Fv_C-variants/Dotplot_analysis/               
